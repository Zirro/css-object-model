...
function serializeACSSDeclaration(property, value, important = false) {
  ...
  // " !important" (U+0020 U+0021 U+0069
  // U+006D U+0070 U+006F U+0072 U+0074
...
function simpleSerializeCSSDeclarationBlock(declarationBlock) {
  return declarationBlock.children.map(({ property, value, important }) => {
    return serializeACSSDeclaration(property, serializeACSSComponentValue(value), important);
  }).join(" ");
}
