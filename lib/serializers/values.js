...
function serializeACSSComponentValue(valueList) {
  const componentTypes = {
    ...
    Identifier({ name }) {
      return serializeAnIdentifier(name);
    },
  ...
  // If it is a list, serialize each component of the value
  ...
  // Otherwise serialize just the one value
  return componentTypes[valueList.type](valueList);
}
